function Doctor(nombre, numero_de_cedula, clave, edad, sexo, raza, nacionalidad,  e_civil, ocupacion, lugar_de_origen, lugar_de_residencia, domicilio, persona_responsable, religion, antecedentes,colegio){
  this.nombre = nombre;
...
var inputs = function(){
  ...
  var users = new Doctor(nombre, numero_de_cedula, clave, edad, sexo, raza, nacionalidad,  e_civil, ocupacion, lugar_de_origen, lugar_de_residencia, domicilio, persona_responsable, religion, antecedentes, colegio)
  lista_users = users;
}